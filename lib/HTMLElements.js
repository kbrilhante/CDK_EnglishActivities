 ...
 */
function createLink(parent, href, text = "", target = "_blank") {
 ...
 * @returns {String}
 */
function createLinkButton(parent, href, text = "", target = "_blank") {
    const link = createLink(parent, href, target, text);
